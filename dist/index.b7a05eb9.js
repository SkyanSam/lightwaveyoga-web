...
const createLandmarkers = async ()=>{
    const vision = await (0, _tasksVision.FilesetResolver).forVisionTasks("https://cdn.jsdelivr.net/npm/@mediapipe/tasks-vision@0.10.3/wasm" // use 0.10.0 or 0.10.3
    );
...
function enableCam() {
    ...
    if (webcamRunning === true) webcamRunning = false;
    else webcamRunning = true;
...
async function predictWebcam() {
    ...
    if (lastVideoTime !== video.currentTime) {
        ...
        poseLandmarker.detectForVideo(video, startTimeMs, (result)=>{
            ...
            for (const landmark of result.landmarks)poseLandmarks = landmark;
            canvasCtx.restore();
        });
        // Get landmarks from face model.
        let results = faceLandmarker.detectForVideo(video, startTimeMs);
        if (results.faceLandmarks) for (const landmarks of results.faceLandmarks)faceLandmarks = landmarks;
        // Draw the chakras.
...
function drawChakras(landmark, faceLandmark) {
    ...
    if (!isNull(faceLandmark) && !isNull(top_head_pt)) chakra_points.push(lerp(chakra_points[4], top_head_pt, 1.05));
    else chakra_points.push({
        x: 0,
        y: 0,
        z: 0
    });
    // Update chakra HTML elements and their positions.
    for(let i = 0; i < 7; i++)if (!isNull(chakras[i]) && !isNull(chakra_points[i]) && !isNull(webcam)) {
        ...
        if (left_pos > cam_width || left_pos < 0 || top_pos < 0 || top_pos > cam_height) chakras[i].style.visibility = "hidden";
        else {
...
parcelHelpers.export(exports, "DrawingUtils", ()=>Fa) //# sourceMappingURL=vision_bundle_mjs.js.map
;
parcelHelpers.export(exports, "FaceDetector", ()=>qa);
parcelHelpers.export(exports, "FaceLandmarker", ()=>hh);
parcelHelpers.export(exports, "FaceStylizer", ()=>ch);
parcelHelpers.export(exports, "FilesetResolver", ()=>Co);
parcelHelpers.export(exports, "GestureRecognizer", ()=>ph);
parcelHelpers.export(exports, "HandLandmarker", ()=>mh);
parcelHelpers.export(exports, "HolisticLandmarker", ()=>wh);
parcelHelpers.export(exports, "ImageClassifier", ()=>Th);
parcelHelpers.export(exports, "ImageEmbedder", ()=>Ah);
parcelHelpers.export(exports, "ImageSegmenter", ()=>Sh);
parcelHelpers.export(exports, "ImageSegmenterResult", ()=>bh);
parcelHelpers.export(exports, "InteractiveSegmenter", ()=>Yh);
parcelHelpers.export(exports, "InteractiveSegmenterResult", ()=>Lh);
parcelHelpers.export(exports, "MPImage", ()=>Ua);
parcelHelpers.export(exports, "MPMask", ()=>_a);
parcelHelpers.export(exports, "ObjectDetector", ()=>$h);
parcelHelpers.export(exports, "PoseLandmarker", ()=>Qh);
parcelHelpers.export(exports, "TaskRunner", ()=>qo);
parcelHelpers.export(exports, "VisionTaskRunner", ()=>$a);
var t = "undefined" != typeof self ? self : {};
function e(e) {
    t: {
        for(var n = [
            "CLOSURE_FLAGS"
        ], r = t, s = 0; s < n.length; s++)if (null == (r = r[n[s]])) {
            n = null;
            break t;
        }
        n = r;
...
var A = "undefined" != typeof Uint8Array, b = !_ && "function" == typeof btoa;
function k(t) {
    if (!b) {
        var e;
        ...
        for(; h < t.length - 2; h += 3){
            var s = t[h], i = t[h + 1], o = t[h + 2], a = e[s >> 2];
...
function Z(t, e) {
    ...
    else X() ? n = "" + (BigInt(e) << BigInt(32) | BigInt(t)) : (t = (16777215 & t) + 6777216 * (n = 16777215 & (t >>> 24 | e << 8)) + 6710656 * (e = e >> 16 & 65535), n += 8147497 * e, e *= 2, 1e7 <= t && (n += Math.floor(t / 1e7), t %= 1e7), 1e7 <= n && (e += Math.floor(n / 1e7), n %= 1e7), n = e + Q(n) + Q(t));
    return n;
}
function Q(t) {
...
function et(t) {
    ...
    else if (X()) t = BigInt(t), z = Number(t & BigInt(4294967295)) >>> 0, K = Number(t >> BigInt(32) & BigInt(4294967295));
    else {
        const e = +("-" === t[0]);
        K = z = 0;
        const n = t.length;
...
function yt(t, e, n) {
    const r = t.g.l, s = ot(t.g), i = t.g.g + s;
    let o = i - r;
...
var zt = jt ? (t)=>0 | t[jt] : (t)=>0 | t.g, Kt = jt ? (t)=>t[jt] : (t)=>t.g, Yt = jt ? (t, e)=>(t[jt] = e, t) : (t, e)=>(void 0 !== t.g ? t.g = e : Object.defineProperties(t, {
        g: {
            value: e,
            configurable: !0,
            writable: !0,
...
function an(t, e) {
    t = t.u;
    let n = Kt(t);
    const r = nn(t, n, e), s = fe(r);
    return null != s && s !== r && sn(t, n, e, s), s;
}
function hn(t) {
    t = t.u;
    let e = Kt(t);
    const n = nn(t, e, 1), r = se(n, !0, !!(34 & e));
...
function pn(t, e, n) {
    {
        ...
        if (ae(a), null == n) sn(o, a, e);
            ...
            var r, s = t = zt(n), i = !!(2 & t) || Object.isFrozen(n);
...
function Bn(t) {
    return Array.isArray(t) ? t[0] instanceof Ut ? t : [
        Gr,
        t
    ] : [
        t,
    ...
    if (!e) {
        ...
        e = s ? (t, e)=>s(t, e, r) : (t, e)=>{
            for(; gt(e) && 4 != e.h;){
                ...
                i && i(e, t, s) || (s = (i = e).l, mt(i), i.ia ? i = void 0 : (o = i.g.g - s, i.g.g = s, i = ft(i.g, o)), s = t, i && (ce ||= Symbol(), (o = s[ce]) ? o.push(i) : s[ce] = [
                    i
                ]));
            }
...
var mr = pr(function(t, e, n, r, s) {
    return 2 === t.h && (t = yt(t, Oe([
        void 0,
        void 0
    ], r), s), ae(r = Kt(e)), (s = nn(e, r, n)) instanceof je ? 0 != (2 & s.L) ? ((s = s.Y()).push(t), sn(e, r, n, s)) : s.Oa(t) : Array.isArray(s) ? (2 & zt(s) && sn(e, r, n, s = fn(s)), s.push(t)) : sn(e, r, n, [
        t
    ]), !0);
}, function(t, e, n, r, s) {
...
}, yr), Rr = dr(function(t, e, n) {
    return 0 === t.h && (gr(e, n, 0 === (t = rt(t.g, J)) ? void 0 : t), !0);
}, yr), Mr = dr(function(t, e, n) {
...
}, _r), Ir = dr(function(t, e, n) {
    return 0 === t.h && (gr(e, n, st(t.g)), !0);
}, vr), Dr = dr(function(t, e, n) {
    return 0 === t.h && (gr(e, n, !1 === (t = st(t.g)) ? void 0 : t), !0);
}, vr), Nr = fr(function(t, e, n) {
...
}, Er), Br = dr(function(t, e, n) {
    return 2 === t.h && (gr(e, n, _t(t)), !0);
}, Er), Gr = pr(function(t, e, n, r, s) {
    return 2 === t.h && (yt(t, En(e, r, n, !0), s), !0);
}, wr), jr = pr(function(t, e, n, r, s) {
...
}, wr), Xr = dr(function(t, e, n) {
    return 2 === t.h && (gr(e, n, vt(t)), !0);
}, Tr), Hr = fr(function(t, e, n) {
...
function ko(t) {
    var e = cn(t, 3, fe), n = cn(t, 2, ye), r = cn(t, 1, xe), s = cn(t, 9, xe);
    const i = {
        categories: [],
        keypoints: []
    };
...
function Bo(t, e, n) {
    ...
    const [r, s] = No(e);
    return !t.l || r === t.i.canvas.width && s === t.i.canvas.height || (t.i.canvas.width = r, t.i.canvas.height = s), [
        r,
        s
    ];
}
...
function ta(t, e) {
    const n = t.g, r = Jo(n.createVertexArray(), "Failed to create vertex array");
    n.bindVertexArray(r);
    const s = Jo(n.createBuffer(), "Failed to create buffer");
    n.bindBuffer(n.ARRAY_BUFFER, s), n.enableVertexAttribArray(t.P), n.vertexAttribPointer(t.P, 2, n.FLOAT, !1, 0, 0), n.bufferData(n.ARRAY_BUFFER, new Float32Array([
        -1,
        -1,
        -1,
        1,
    ...
    return n.bindBuffer(n.ARRAY_BUFFER, i), n.enableVertexAttribArray(t.O), n.vertexAttribPointer(t.O, 2, n.FLOAT, !1, 0, 0), n.bufferData(n.ARRAY_BUFFER, new Float32Array(e ? [
        0,
        1,
        0,
        0,
        ...
        1,
        0
    ]), n.STATIC_DRAW), n.bindBuffer(n.ARRAY_BUFFER, null), n.bindVertexArray(null), new Zo(n, r, s, i);
}
function ea(t, e) {
    if (t.g) {
...
function fa(t) {
    if (t = da(t), !ya) {
        if (t.getExtension("EXT_color_buffer_float") && t.getExtension("OES_texture_float_linear") && t.getExtension("EXT_float_blend")) ya = t.R32F;
        else {
...
function xa(t, e, n) {
    if (e.R()) n(e.M());
        ...
        n((t = new _a([
            r
        ], e.m, !1, s.canvas, t.m, e.width, e.height)).M()), t.close();
    }
}
function Sa(t, e, n, r) {
    const s = function(t) {
        return t.g || (t.g = new aa), t.g;
    }(t), i = ka(t), o = Array.isArray(n) ? new ImageData(new Uint8ClampedArray(n), 1, 1) : n;
    na(s, i, !0, ()=>{
        !function(t, e, n, r) {
            const s = t.g;
            if (s.activeTexture(s.TEXTURE0), s.bindTexture(s.TEXTURE_2D, e), s.activeTexture(s.TEXTURE1), s.bindTexture(s.TEXTURE_2D, t.C), s.texImage2D(s.TEXTURE_2D, 0, s.RGBA, s.RGBA, s.UNSIGNED_BYTE, n), t.I && function(t, e) {
                ...
                return !!e.next().done;
            }(t.I, r)) s.activeTexture(s.TEXTURE2), s.bindTexture(s.TEXTURE_2D, t.j);
            else {
                t.I = r;
...
function Ma(t) {
    ...
    if (!e) {
        e = Oa(t);
        const n = Ca(t), r = new Uint8Array(t.width * t.height * 4);
...
function Ya(t, e, n, r) {
    ...
    return t = new _a([
        s
    ], n, !1, t.g.i.canvas, t.O, i, e), r ? t.clone() : t;
}
...
var ch = class extends $a {
    ...
    m() {
        ...
        ms(n, "mediapipe.tasks.vision.face_stylizer.FaceStylizerGraph"), ys(n, "IMAGE:image_in"), ys(n, "NORM_RECT:norm_rect"), _s(n, "STYLIZED_IMAGE:stylized_image"), n.o(e), ks(t, n), this.g.W("stylized_image", (t, e)=>{
            var n = !this.h, r = t.data, s = t.width;
            ...
            s = new Ua([
                r
            ], !1, !1, this.g.i.canvas, this.O, s, t), this.s = n = n ? s.clone() : s, this.h && this.h(n), zo(this, e);
...
var ph = class extends $a {
    ...
    o(t) {
        if (Cn(this.v, 3, t.numHands ?? 1), "minHandDetectionConfidence" in t && In(this.v, 2, t.minHandDetectionConfidence ?? .5), "minTrackingConfidence" in t && In(this.s, 4, t.minTrackingConfidence ?? .5), "minHandPresenceConfidence" in t && In(this.D, 2, t.minHandPresenceConfidence ?? .5), t.cannedGesturesClassifierOptions) {
            var e = new Gi, n = e, r = Ao(t.cannedGesturesClassifierOptions, Tn(this.h, Gi, 3)?.h());
            ...
            t = gi(t), this.embeddings = function(t) {
                return {
                    embeddings: bn(t, li, 1).map((t)=>{
                        ...
                        if (void 0 !== wn(t, ci, _n(t, 1))) t = cn(t = Tn(t, ci, _n(t, 1)), 1, fe), e.floatEmbedding = t.slice();
                        else {
...
},{}]},["dZI1r","jeorp"], "jeorp", "parcelRequired238")
